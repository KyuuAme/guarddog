...
from guarddog.helpers import get_gender
...
def _member_replacements(string: str, member: discord.Member) -> str:
    ...
    """
    string = string.replace('{gender}', get_gender(member))
    string = string.replace('{gender=noun}', get_gender(member, noun=True))
    string = string.replace('{gender=their}', get_gender(member, their=True))
